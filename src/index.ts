...
const addBlock = (candidateBlock : Block) : void => {// void return값이 없을경우
	if(isBlockValid(candidateBlock, getLatestBlock())) {
		blockchain.push(candidateBlock);
	}
}

createNewBlock('BlockChain 02');
createNewBlock('BlockChain 03');
createNewBlock('BlockChain 04');
createNewBlock('BlockChain 05');
